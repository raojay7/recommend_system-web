...
function initChart2(path,myChart) {
    // 初始化要显示的图标div
    //var myChart = echarts.init(document.getElementById('my_chart2'));
    ...
    httpRequest.onreadystatechange = function(){
        if(httpRequest.readyState == 4 && httpRequest.status == 200){
            ...
            var convertedData = getData(data);
            var option = {
                ...
                title: [
                    {
                        text: '全国主要城市企业分布',
                        subtext: 'data from 智联招聘',
                        sublink: 'http://www.zhaopin.com',
                        left: 'center',
                        textStyle: {
                            color: '#fff'
                        }
