...
<div class="layui-layout layui-layout-admin">
    ...
    <script>
        layui.use('table', function () {
            ...
            table.render({
                elem: '#LAY_table_job'
                , url: '../action/show?uid=<%=uid%>'
                , cellMinWidth: 80
                , cols: [[
                    {fixed: 'left', title:'操作', width:70, align:'center', toolbar: '#barDemo'},
    ...
    <script>
        layui.use('table', function () {
            ...
            table.on('tool(demoEvent)', function (obj) {
                ...
                if(obj.event === 'del'){
                    window.location.href = "../action/delete?uid=<%=uid%>&jid=" + data.jobId;
                }
